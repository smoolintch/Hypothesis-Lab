...
def build_payload() -> dict[str, object]:
    # backtest_range must fall within the fixture data coverage:
    # BTCUSDT/4H/sample-v1 covers 2024-01-01T00:00:00Z to 2024-01-02T00:00:00Z
    return {
...
def test_start_backtest_creates_snapshot_and_run(client: TestClient) -> None:
    ...
    data = body["data"]
    # Real execution: status should be succeeded (or failed if data unavailable)
    ...
    assert polled["status"] in ("succeeded", "failed")
